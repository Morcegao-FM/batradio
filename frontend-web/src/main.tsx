...
// Tipografia do design system da Morcegão FM (.claude/skills/morcegaofm-design):
// Archivo Black no pôster, Archivo na UI, Figtree no corpo, Space Mono nos labels.
